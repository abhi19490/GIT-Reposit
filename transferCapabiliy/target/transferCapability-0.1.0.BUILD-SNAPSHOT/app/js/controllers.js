						...
						function($scope, $filter, $location,
							...
							$scope.my = function() {
								...
								setTimeout(
										function() {
											document
													.getElementById("map_canvas").style.borderColor = "#34AFD4";
										}, 1000);
								setTimeout();
...
myControllers.controller('chartCompareController', [ '$scope', '$filter',
                                            		'$location', 'chartCompRecord', '$http','$rootScope',
                                            		function($scope, $filter, $location, chartCompRecord, $http,$rootScope) {
                                            			/*$scope.compList = chartCompRecord.query();*/
														
													    $scope.cost=2014;
													    $scope.searchFun=function(){
														var search=$scope.cost;
														alert("AAYA "+$scope.cost);
